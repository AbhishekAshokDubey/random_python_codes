...
About the file: 
                ...
                assets as well as people predictions
...
#datafile_path = r"file_path";
datafile_path = r"file_name";

use_col = ["c1","c2", ..., "cn"];

attribute_names = ["a1","a2","a3","a4"]
most_granular_feature = "g1"

target_var = "y_response";

activity_var = "ah1";

projectNo_col_name = "p1"
